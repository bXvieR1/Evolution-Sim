...
class DefaultGenome(object):
    ...
    def configure_crossover(self, genome1, genome2, generation, config):
        ...
        self.radius = (parent1.radius * 2 + parent2.radius) / 3
        self.speed = (parent1.speed * 2 + parent2.speed) / 3
        self.range = (parent1.range * 2 + parent2.range) / 3

        self.createdGeneration = generation
